...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_TODO),
          REQUEST(ACTION_TYPES.UPDATE_TODO),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_TODO),
          REQUEST(ACTION_TYPES.DELETE_TODO),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_TODO),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_TODO actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_TODO),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_TODO),
          payload: resolvedObject,
        },
      ];
