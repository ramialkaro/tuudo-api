...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_COURSE: 'course/PARTIAL_UPDATE_COURSE',
...
export default (state: CourseState = initialState, action): CourseState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_COURSE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_COURSE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_COURSE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<ICourse> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_COURSE,
