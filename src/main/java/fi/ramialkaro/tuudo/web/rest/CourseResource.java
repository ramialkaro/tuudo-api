...
/**
 * REST controller for managing {@link fi.ramialkaro.tuudo.domain.Course}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingCourse -> {
                    ...
                    if (course.getPoint() != null) {
                        existingCourse.setPoint(course.getPoint());
                    }
                    if (course.getProgress() != null) {
                        existingCourse.setProgress(course.getProgress());
                    }
