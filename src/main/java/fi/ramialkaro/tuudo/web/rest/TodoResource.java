...
import fi.ramialkaro.tuudo.repository.TodoRepository;
...
/**
 * REST controller for managing {@link fi.ramialkaro.tuudo.domain.Todo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingTodo -> {
                    ...
                    if (todo.getStartAt() != null) {
                        existingTodo.setStartAt(todo.getStartAt());
                    }
                    if (todo.getEndAt() != null) {
                        existingTodo.setEndAt(todo.getEndAt());
                    }
