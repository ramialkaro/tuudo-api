...
import fi.ramialkaro.tuudo.repository.CourseRepository;
...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().name(DEFAULT_NAME).point(DEFAULT_POINT).progress(DEFAULT_PROGRESS).url(DEFAULT_URL);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().name(UPDATED_NAME).point(UPDATED_POINT).progress(UPDATED_PROGRESS).url(UPDATED_URL);
        return course;
    }
    ...
    void createCourse() throws Exception {
        ...
        assertThat(testCourse.getProgress()).isEqualTo(DEFAULT_PROGRESS);
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.name(UPDATED_NAME).point(UPDATED_POINT).progress(UPDATED_PROGRESS).url(UPDATED_URL);
        ...
        assertThat(testCourse.getProgress()).isEqualTo(UPDATED_PROGRESS);
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.name(UPDATED_NAME).point(UPDATED_POINT).progress(UPDATED_PROGRESS).url(UPDATED_URL);
